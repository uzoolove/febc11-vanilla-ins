...
<style>
  ...
  .toggle-icon::after {
    background: url(/icons/arrowBottom.svg) no-repeat 0px 0px;
    content: '';
...
<footer class="footer">
  ...
  <div class="footer-bottom">
    ...
    <div class="company-info">
      (유)나이키코리아 대표 Kimberlee Lynn Chang Mendes, 킴벌리 린 창 멘데스 | 서울 강남구 테헤란로 152 강남파이낸스센터 30층 | 통신판매업신고번호 2011-서울강남-03461 |
      등록번호 220-88-09068 사업자 정보 확인<br>
  ...
  // 모바일에서 footer 타이틀 클릭시 메뉴 펼치기 토글
  setupEventListeners() {
